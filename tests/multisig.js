...
describe("multisig", () => {
  ...
  const program = anchor.workspace.MultisigWallet;
  ...
  it("Tests the multisig program", async () => {
    ...
    // Multisig wallet transaction creation
    ...
    const txSize = 1000; // Big enough, only for development purposes
    ...
    // Multisig wallet transaction creation approving
    ...
    // Multisig wallet transaction execution
    await program.rpc.executeTransaction({
      ...
      remainingAccounts: program.instruction.setOwners
        .accounts({
          multisigWallet: multisig.publicKey,
          multisigSigner,
        })
    ...
    multisigAccount = await program.account.multisigWallet.fetch(multisig.publicKey);
